...
public class UserListView extends MDIChild {	
	...
	public UserListView(String title, UserListController list, MDIParent m) {
		...
		//prep list view
		myList = list;
		listUsers = new JList<User>(myList);
	...
	private void deleteUser() {
		...
		if(idx >= myList.getSize())
			return;
		User d = myList.getElementAt(idx);
		if(d == null)
			return;
		selectedModel = d;
	...
	public JList<User> getListUsers() {
		return listUsers;
	}

	public void setListUsers(JList<User> listPeople) {
		this.listUsers = listPeople;
	}

	public User getSelectedModel() {
		return selectedModel;
	}

	public void setSelectedModel(User selectedModel) {
	...
	private class UserDragTransferHandler extends TransferHandler {
		...
		public Transferable createTransferable(JComponent comp) {
	        ...
	        return new TransferableUser( (User) listUsers.getSelectedValue());
	    }
