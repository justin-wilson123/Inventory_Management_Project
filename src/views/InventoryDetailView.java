...
public class InventoryDetailView extends MDIChild implements Observer {
	...
	// warehouse	
		...
		// get warehouse list
		warehouseList = myInventory.getWarehouseList(m).getWList();
	...
	// get size of warehouse List
		...
		partList = myInventory.getPartList(m).getPList();
	...
	public boolean saveModel() {
		...
		try {
			...
			Warehouse warehouse = mdiparent.getWarehouseList().findById(myInventory.getWarehouseId());
			Long totalCapacity = warehouse.getStorageCapacity();
