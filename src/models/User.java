...
/**
 * User data and domain behavior like validators
...
public class User extends Observable {
	...
	public User( String user, String password, String fullName, String add, String edit, String delete ) {
		this();
		//validate parameters
	...
	public User( long id, String user, String password, String fullName, String add, String edit, String delete) {
	...
	public boolean getValidAdd(String add){
		...
		if( add.equals("no") || add.equals("yes"))
			return true;
		else if ( add.equals("No") || add.equals("Yes"))
			return true;
	...
	public boolean getValidEdit(String edit){
		...
		if( edit.equals("no") || edit.equals("yes"))
			return true;
		else if ( edit.equals("No") || edit.equals("Yes"))
			return true;
		else
			return false;	
	}
	...
	public boolean getValidDelete(String delete){
		...
		if( delete.equals("no") || delete.equals("yes"))
			return true;
		else if ( delete.equals("No") || delete.equals("Yes"))
			return true;
		else
			return false;	
	}
